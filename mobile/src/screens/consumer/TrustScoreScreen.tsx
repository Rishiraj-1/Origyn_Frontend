    ...
    <SafeAreaView className="flex-1 bg-navy-900">
      ...
      <ScrollView className="flex-1 px-4">
        ...
        <View className="bg-navy-800 rounded-2xl p-5 mb-6 border border-white/10">
          ...
          <Text className="text-white text-2xl font-bold mb-4">Premium Organic Apples</Text>
          
          <View className="flex-row flex-wrap">
            <View className="w-1/2 mb-4">
              <View className="flex-row items-center mb-1">
                <MapPin color="#6B7280" size={16} />
                <Text className="text-gray-400 text-xs ml-1">Origin</Text>
              </View>
              <Text className="text-white font-medium">Shimla, HP</Text>
            </View>
            <View className="w-1/2 mb-4">
              <View className="flex-row items-center mb-1">
                <Snowflake color="#6B7280" size={16} />
                <Text className="text-gray-400 text-xs ml-1">Cold Chain</Text>
              </View>
              <Text className="text-green-accent font-medium">Maintained</Text>
            </View>
            <View className="w-1/2">
              <Text className="text-gray-400 text-xs mb-1">Batch ID</Text>
              <Text className="text-white font-medium text-xs">#ORG-APP-8922</Text>
            </View>
            <View className="w-1/2">
              <Text className="text-gray-400 text-xs mb-1">Expiry</Text>
              <Text className="text-white font-medium text-xs">12 May 2026</Text>
            </View>
          </View>
        </View>
        ...
        <View className="bg-consumer/10 rounded-2xl p-5 mb-8 border border-consumer/20 flex-row items-center justify-between">
          <View className="flex-row items-center">
            ...
            <View>
              <Text className="text-consumer font-bold text-lg">+15 ORIGYN</Text>
